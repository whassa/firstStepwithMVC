...
class ControleurEnvoyer extends Controleur {
		...
		if (isset($image) AND $image['error'] == 0) {
            ...
            if ($dimension <= 1000000) {
                ...
                if (in_array($extension_upload, $extensions_autorisees)) {
					...
					basename($image['name']);
					$this->Client->ajouterClient($prenom,$nom,$telephone,$adresse,$ville,$province,$pays,$email, $image['name']);
                } else {
           ...
           $this->Client->ajouterClient($prenom,$nom,$telephone,$adresse,$ville,$province,$pays,$email,"");
        }
